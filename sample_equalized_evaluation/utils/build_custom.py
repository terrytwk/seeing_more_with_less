...
The purpose of this modification serves the EXPERIMENTS/bin_evaluation_complete_paradigm script.
...
In this way, the EXPERIMENTS/... script is able to perform the evaluation on each bin without
